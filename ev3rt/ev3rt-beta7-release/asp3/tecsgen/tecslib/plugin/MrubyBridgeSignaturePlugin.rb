...
#cdl_info( "check_parameter_type type_org=#{type_org} type_str=#{type_str} func_head_array=#{func_head_array}" )
        b_ng = false
        case type_org
        when IntType
          ...
          when -1, -2, -3, -4, -11
            ...
            b_ng = true
            cdl_info("CI 1 type_org=IntType type_org.get_bit_size=#{type_org.get_bit_size}")
          end
        when BoolType
        when FloatType
        when PtrType
